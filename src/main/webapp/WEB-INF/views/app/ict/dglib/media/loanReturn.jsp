...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/resources/ict/dglib/media/css/loanReturn.css">
    ...
    <script src="/resources/ict/dglib/media/js/loanReturn.js"></script>
            ...
            <div class="rtnTodayContent">
                ...
                <div class="rtnItem rtnLend">
                    <div class="rtnLabel rtnLabelLend">
                        ...
                        <div class="labelEn">Lending Day</div>
                    </div>
                    <div class="rtnDate rtnDateLend">
                        <div class="dateMon">
                            <div class="dateNum">11</div>
                ...
                <div class="rtnItem rtnReturn">
                    <div class="rtnLabel rtnLabelReturn">
                        ...
                        <div class="labelEn">Return Day</div>
                    </div>
