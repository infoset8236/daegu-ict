...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/resources/ict/dglib/media/css/stairs1.css">
    ...
    <script src="/resources/ict/dglib/media/js/stairs1.js"></script>
...
<div id="container">
    ...
    <div class="top">
        <div class="welcomeMessage">
            ...
            <div>Welcome to Daegu metropolitan library</div>
        </div>
    </div>
