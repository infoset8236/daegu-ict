...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/resources/ict/dglib/ai/css/index.css">
    ...
    <script src="/resources/ict/dglib/ai/js/index.js"></script>
