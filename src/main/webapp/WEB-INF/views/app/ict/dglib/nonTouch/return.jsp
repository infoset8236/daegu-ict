...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/resources/ict/dglib/nonTouch/css/return.css">
    ...
    <script src="/resources/ict/dglib/nonTouch/js/return.js"></script>
...
<div class="container">
    <div class="headerKoEnVert">
        <div>BOOK RETURN DATE</div>
        <div>대출반납일</div>
    </div>
    <div class="content">
        <div class="title">
            오늘 빌린 책은<br>언제 반납하나요?
        </div>
        <div class="lendingDay">
            <div>책 빌려간 날</div>
            <div>lendingDay</div>
        </div>
