...
public class NonTouchController extends BaseController {
    ...
    public String chat (@PathVariable String context_path, Model model, HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        return basePath(context_path) + "bestBook";
    }
    ...
    public String life (@PathVariable String context_path, Model model, HttpServletRequest request, HttpServletResponse response) throws Exception {

        return basePath(context_path) + "life";
    }

    @RequestMapping(value = {"/newBook.*"})
    public String newBook (@PathVariable String context_path, Model model, HttpServletRequest request, HttpServletResponse response) throws Exception {

        return basePath(context_path) + "newBook";
    }
    ...
    public String nonTouchReturn (@PathVariable String context_path, Model model, HttpServletRequest request, HttpServletResponse response) throws Exception {
